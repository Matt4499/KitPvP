...
public class Cooldown {
    ...
    public Cooldown(String formattedCooldown) {
        ...
        for (String unit : units) {
            if (unit.toUpperCase().endsWith("D")) {
                days = Integer.parseInt(unit.split("D")[0]);
            } else if (unit.toUpperCase().endsWith("H")) {
                hours = Integer.parseInt(unit.split("H")[0]);
            } else if (unit.toUpperCase().endsWith("M")) {
                minutes = Integer.parseInt(unit.split("M")[0]);
            } else if (unit.toUpperCase().endsWith("S")) {
                seconds = Integer.parseInt(unit.split("S")[0]);
            }
        }
    }
