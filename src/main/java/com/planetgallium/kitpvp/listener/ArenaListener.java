...
public class ArenaListener implements Listener {
    ...
    public void onHunger(FoodLevelChangeEvent e) {
        ...
        if (config.getBoolean("Arena.NoKitPreventHunger") && !arena.getKits().hasKit(p.getName())) {
            e.setCancelled(true);
        }
    }
    @EventHandler
    ...
    public void onEntityDamage(EntityDamageByEntityEvent e) {
        if (Toolkit.inArena(e.getEntity())) {
            if (e.getEntity() instanceof Player damagedPlayer && e.getDamager() instanceof Projectile) {
    ...
    public void onPearl(PlayerTeleportEvent e) {
        ...
        if (Toolkit.inArena(p)) {
            if (e.getCause() == TeleportCause.ENDER_PEARL) {
                e.setCancelled(true);
                p.teleport(Objects.requireNonNull(e.getTo()));
            }
        }
    }
    @EventHandler
